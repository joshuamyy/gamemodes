...
new const g_aWeaponItems[][e_WeaponItems] = {
	{WEAPON_KNIFE, 1000, PLAYER_NORMAL},
	{WEAPON_SILENCED, 3000, PLAYER_NORMAL},
	{WEAPON_SHOTGUN, 7500, PLAYER_NORMAL},
	{WEAPON_RIFLE, 9000, PLAYER_NORMAL},
	{WEAPON_DEAGLE, 10000, PLAYER_NORMAL},
	{WEAPON_MP5, 3500, PLAYER_OFFICIAL},
	{WEAPON_AK47, 4000, PLAYER_OFFICIAL}
};
...
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.0, 1489.3204,-1719.4448,8.2429)) 
...
CMD:buymaterials(playerid, params[]) {
    ...
    if(!IsPlayerInRangeOfPoint(playerid, 3.0, 2459.5911,-947.8937,80.0833)) 
